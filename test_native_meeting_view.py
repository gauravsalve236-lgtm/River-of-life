...
with sync_playwright() as p:
    ...
    page.goto('http://localhost:8092/index.html?v=v112_test_' + str(int(time.time())))
    time.sleep(3.5)
    ...
    time.sleep(3.5)
    page.screenshot(path='v112_android_chrome_fix_verified.png')

    browser.close()
    print('Android Chrome fix screenshot captured cleanly!')
