...
with sync_playwright() as p:
    ...
    page.goto('http://localhost:8092/index.html?v=v97_test_' + str(int(time.time())))
    time.sleep(3.5)
    ...
    time.sleep(3.5)
    page.screenshot(path='v97_safari_mic_preset_verified.png')

    browser.close()
    print('Safari mic preset meeting room screenshot captured cleanly!')
