...
with sync_playwright() as p:
    ...
    page.goto('http://localhost:8092/index.html?v=v103_test_' + str(int(time.time())))
    time.sleep(3.5)
    ...
    time.sleep(3.5)
    page.screenshot(path='v103_restored_inapp_meeting_verified.png')

    browser.close()
    print('Restored in-app meeting room screenshot captured cleanly!')
