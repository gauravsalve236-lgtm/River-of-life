...
with sync_playwright() as p:
    ...
    page.goto('http://localhost:8092/index.html?v=v94_test_' + str(int(time.time())))
    time.sleep(3.5)
    ...
    time.sleep(3.5)
    page.screenshot(path='v94_direct_join_5_button_call_verified.png')

    browser.close()
    print('Direct Join 5-button meeting room screenshot captured cleanly!')
