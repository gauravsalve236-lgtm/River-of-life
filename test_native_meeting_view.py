...
with sync_playwright() as p:
    ...
    page.goto('http://localhost:8092/index.html?v=v111_test_' + str(int(time.time())))
    time.sleep(3.5)
    ...
    time.sleep(3.5)
    page.screenshot(path='v111_fullscreen_stage_verified.png')

    browser.close()
    print('Fullscreen stage zero topbar screenshot captured cleanly!')
