...
def run_test():
    ...
    with sync_playwright() as p:
        ...
        print("\n--- Testing Clean High-Res Artwork Match for Wedding at Cana ---")
        ...
        page.screenshot(path=os.path.join(DIRECTORY, "v425_clean_artwork_wedding_cana.png"))
        print("Saved screenshot: v425_clean_artwork_wedding_cana.png")
